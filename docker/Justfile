...
# with that subdirectory as a prefix, e.g. "convert/v1.2.3" for the module
# rooted at ./convert. No goreleaser, no changelog generation - just a
# correct, minimal, annotated tag pushed to origin.
#
# Usage:
#   just release convert v1.2.3
# just release convert 1.2.3      # "v" prefix is added if missing
[group('release')]
